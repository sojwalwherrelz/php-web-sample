        ...
        <?php
                    ...
                    if(!empty($matchList)){
                       ...
                       ?>
                        ...
                        <td><?php if(isset($listdata->matchType)) { echo $listdata->matchType;}else{ echo "No status Found"; } ?></td>
                        ...
                        <td><?php if(isset($listdata->series_id)) { echo $listdata->series_id; }else{ echo  "No date Data Found"; } ?></td>
